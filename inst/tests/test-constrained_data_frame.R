...
########
context("Subclass of psData [<- method")
...
context("subclass of psData [[<- methods")
...
context("subclass of psData cbind2 method")
...
### rbind2
context("subclass of psData rbind2 method")
...
### colnames<-
context("subclass of psData colnames<- method")
...
####
context("subclass of psData rownames<- method")
...
####
context("subclass of psData names<- method")
...
####
context("subclass of psData dimnames<- method")
